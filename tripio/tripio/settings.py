...
SECRET_KEY = os.environ.get('SECRET_KEY',"ybi0o34d07-71&e38!sjv6-*q+8l^6215u-+r433ln0j3ldy$y")
if not SECRET_KEY:
...
# Application name
APP_NAME = os.environ.get('APP_NAME', 'Tripio')
...
INSTALLED_APPS = [
    ...
    'django.contrib.gis',  # For maps and location-based features
    ...
    'taggit',  # For tagging
    'easy_thumbnails',  # For image processing
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.app_settings',  # Make app settings available to templates
            ],
        },
    },
]

WSGI_APPLICATION = 'tripio.wsgi.application'
ASGI_APPLICATION = 'tripio.asgi.application'

# Database
# DATABASES = {
#     'default': {
#         'ENGINE': 'django.contrib.gis.db.backends.postgis',
#         'NAME': os.environ.get('DB_NAME', 'tripio'),
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'db.sqlite3',  # Uses the default database file in the project root
    }
}
# # Cache configuration
# CACHES = {
...
ALLOWED_UPLOAD_IMAGES = ['image/jpeg', 'image/png', 'image/gif', 'image/webp']
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'tripio.log',
